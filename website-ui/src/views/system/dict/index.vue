    ...
    <div class="ant-table ant-table-scroll-position-left ant-table-default ant-table-bordered">
      ...
      <form class="ant-form ant-form-horizontal search-form" onsubmit="return false;">
        <div class="form-content">
          <span class="ant-col ant-form-item-label search-label">字典状态</span>
        ...
        <div class="form-content">
          ...
          <div class="clearfix" style="display: inline-flex;">
            <a-select class="search-type" placeholder="请选择" v-model="searchForm.searchType">
              ...
              <a-select-option value="dictName">字典名称</a-select-option>
              <a-select-option value="dictType">字典类型</a-select-option>
            </a-select>
              ...
              <tr :key="item.id">
                ...
                <td>
                  <router-link class="ant-btn ant-btn-primary ant-btn-sm"
                               :to="{path:'/system/dict/edit',query:{id:item.id}}">
                    <a-icon type="edit"/>
                    编辑
                  </router-link>
                  <router-link class="ant-btn ant-btn-info ant-btn-sm"
                               :to="{path:'/system/dict/data',query:{type:item.dictType}}">
                    <a-icon type="menu"/>
                    列表
                  </router-link>
...
<script>
import {getList, setStatus} from '@/api/system/dict/index'
...
export default {
  ...
  created () {
    ...
    getDicts('dict_status').then(result => {
  ...
  methods: {
    getList (params) {
      this.$router.replace({path: '/system/dict/index', query: params})
