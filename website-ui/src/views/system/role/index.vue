    ...
    <div class="ant-table ant-table-scroll-position-left ant-table-default ant-table-bordered">
      ...
      <form class="ant-form ant-form-horizontal search-form" onsubmit="return false;">
        <div class="form-content">
          <span class="ant-col ant-form-item-label search-label">角色状态</span>
              ...
              <tr :key="item.id">
                ...
                <td>
                  <router-link class="ant-btn ant-btn-primary ant-btn-sm"
                               :to="{path:'/system/role/edit',query:{id:item.id}}">
                    <a-icon type="edit"/>
                    编辑
                  </router-link>
                  ...
                  <router-link class="ant-btn ant-btn-outline-primary ant-btn-sm"
                               :to="{path:'/system/role/setRoleMenu',query:{id:item.id}}">
                    <a-icon type="menu"/>
                    设置角色权限
                  </router-link>
                  <router-link class="ant-btn ant-btn-outline-primary ant-btn-sm"
                               :to="{path:'/system/role/setRoleAdmin',query:{id:item.id}}">
                    <a-icon type="user"/>
                    设置角色用户
                  </router-link>
                </td>
...
<script>
import {getList, setStatus} from '@/api/system/role/index'
...
export default {
  ...
  created () {
    ...
    getDicts('role_status').then(result => {
  ...
  methods: {
    getList (params) {
      this.$router.replace({path: '/system/role/index', query: params})
